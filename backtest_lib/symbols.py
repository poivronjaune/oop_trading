...
class Symbols:
    ...
    def extract_symbols_from_web_page(self):
        ...
        listed_symbols_as_strings, delisted_symbols_as_strings = self.__extract_symbol_lines_as_strings(first_line_to_parse)
    ...
    def __extract_symbol_lines_as_strings(self, lines_to_parse):
        TEXT_MARKER = "First Date:" # Text to detect a line with symbols info in the soup
        symbols_listed = []
        symbols_delisted = []
